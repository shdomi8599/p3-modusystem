...
const Photo = ({ photo }: propsData) => {
    ...
    return <>
        ...
        <div id="photo">
            <div id="photo_top">
                <img id="current_img" src={`../images/설치현황/${photo.src[0]}.jpg`} alt='product' onClick={zoomHandeler} />
            </div>
            <div id="photo_bottom">
                <div>{photo.title}</div>
                <div onMouseOver={categoriOver} onMouseOut={categoriOut} >
                    <button id="photo_categori_btn">
                        ...
                        {categori &&
                            <>
                                <img src={"../images/아이콘/right-arrow-black-triangle-38483.png"} alt='triangle' />
