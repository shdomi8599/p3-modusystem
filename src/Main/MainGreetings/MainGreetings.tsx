...
const MainGreetings = () => {
    return <section id="main_section">
        <div id="greetings_box">
            <div>
                안녕하십니까? 주차관제 전문회사<span id="greeting_logo_box"><img className="greetings_logo" src={"../images/MODOO2.png"} /></span>
            ...
            <div><span id="greeting_logo_box"><img className="greetings_logo" id="greetings_bottom_logo" src={"../images/MODOO2.png"} /></span>임직원 일동 올림</div>
        </div>
    </section>
}
