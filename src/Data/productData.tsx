...
//신호관제 상품 
interface productControl extends productRf {
    characteristic?: string[];
}

//나머지 모든 상품
export interface product extends productControl {
    optional?: string[];
}

//Rf카드
export const productRfList: productRf[] =
    [
        {
...
//신호관제
export const productControlList: productControl[] =
    [
        {
            id: "입차 경광등",
